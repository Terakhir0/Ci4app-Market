                ...
                <div class="item-series">
                    ...
                    <div class="tombol-c">
                        ...
                        <form action="/order/beli/<?= $data['produk_id'] ?>" method="post">
                            ...
                            <input type="hidden" name="keywords" value="<?= $keyword_genre ?>">
                            <input type="hidden" name="current" value="<?= $currentPage ?>">
                        ...
                        <form
                            action="<?= (session('log') == true)? '/keranjang/saveCariGenre' : '/keranjangGuest/guest_saveCariGenre' ?> "
                            method="post">
